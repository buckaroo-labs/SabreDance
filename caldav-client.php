...
* https://gitlab.com/davical-project/davical/blob/master/inc/caldav-client.php
*
...
* Updates by heiner@monstro.us:
* 2019-06-19 Add optional $etags_only parameter to functions DoCalendarQuery, GetEvents, and GetTodos
* 2019-06-19 modify function DoOptionsRequest: if ($headers==false) return false
...
PROPP;
  ...
  *               etag (which only varies when the data changes) and (if not specifically excluded by specifying 
  *				  $etags-only) the calendar data in iCalendar format.
  */
  function DoCalendarQuery( $filter, $relative_url = '', $etags_only=false ) {
...
EOXML;
  ...
  */
  function GetEvents( $start = null, $finish = null, $relative_url = '', $etags_only=false ) {
    $filter = "";
...
EOFILTER;
  ...
  * @return array An array of the relative URLs, etags, and events, returned from DoCalendarQuery() @see DoCalendarQuery()
  */
  function GetTodos( $start, $finish, $completed = false, $cancelled = false, $relative_url = "", $etags_only=false  ) {
